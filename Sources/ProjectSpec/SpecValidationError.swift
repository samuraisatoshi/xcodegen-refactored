...
public struct SpecValidationError: Error, CustomStringConvertible {
    ...
    public enum ValidationError: Hashable, Error, CustomStringConvertible {
        ...
        case includedFileOutsideProjectDirectory(path: String)
        ...
        public var description: String {
            ...
            case let .includedFileOutsideProjectDirectory(path):
                return "Include path \(path.quoted) is outside the project directory"
            }
        }
    }
